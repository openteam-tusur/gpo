class ManagersController < ApplicationController
  ...
  filter_access_to :index, :require => :read, :context => :projects, :attribute_check => true
  filter_access_to [:new, :create] do
    permitted_to?(:create, @manager)
  end
  filter_access_to :destroy, :require => :delete, :attribute_check => true
  filter_access_to :cancel, :require => :cancel, :attribute_check => true
  filter_access_to :approve, :require => :approve, :attribute_check => true
