  ...
  def self.global(*types)
    stats_collection = {
      ...
      :participants => [
        ...
        Stat.new(:participant_intersubfaculty,  Project.intersubfaculty.map {|p| p.participants.active.count - p.participants.active.with_subfaculty(p.chair.contingent_abbr || p.chair.abbr).count}.sum,              I18n.t('statistics.participant_intersubfaculty')),
  ...
  def self.for_chair(chair, *types)
     stats_collection = {
      ...
      :participants => [
        ...
        Stat.new(:participant_intersubfaculty,  chair.participants.active.count - chair.participants.active.with_subfaculty(chair.contingent_abbr || chair.abbr).count,         I18n.t('statistics.participant_intersubfaculty')),
