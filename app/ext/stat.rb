  ...
  def self.global(*types)
    stats_collection = {
      ...
      :participants => [
        ...
        Stat.new(:participant_intersubfaculty,  Project.intersubfaculty.map {|p| p.participants.active.count - p.participants.active.with_subfaculty(p.chair.contingent_abbr).count - Participant.active.other_univercity.count}.sum,              I18n.t('statistics.participant_intersubfaculty')),
  ...
  def self.for_chair(chair, *types)
     stats_collection = {
      ...
      :participants => [
        ...
        Stat.new(:participant_intersubfaculty,  chair.participants.active.count - chair.participants.active.with_subfaculty(chair.contingent_abbr).count - chair.participants.active.other_univercity.count,         I18n.t('statistics.participant_intersubfaculty')),
