...
ActiveRecord::Schema.define(version: 20210312071859) do
  ...
  create_table "attestation_marks", force: true do |t|
    t.integer  "mark"
  ...
  add_index "attestation_marks", ["participant_id"], name: "index_attestation_marks_on_participant_id", using: :btree
  add_index "attestation_marks", ["stage_id"], name: "index_attestation_marks_on_stage_id", using: :btree
  ...
  create_table "participant_student_achievements", force: true do |t|
    t.integer  "participant_id"
    t.integer  "student_achievement_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
