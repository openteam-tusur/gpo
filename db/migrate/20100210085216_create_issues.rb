...
<title>db/migrate/20100210085216_create_issues.rb - gpo in АИС &quot;Проекты ГПО&quot; - Gitorious</title>
...
<body id="blobs">
  <div id="wrapper">
    ...
    <div id="top-bar">
      <ul id="breadcrumbs">
        <li class="project"><a href="/tusur-gpo">АИС &quot;Проекты ГПО&quot;</a></li><li class="repository"><a href="/tusur-gpo/gpo">gpo</a></li><li class="branch"><a href="/tusur-gpo/gpo/commits/master">master</a></li><li class="tree"><a href="/tusur-gpo/gpo/trees/master">/</a></li><li class="folder"><a href="/tusur-gpo/gpo/trees/master/db">db</a></li><li class="folder"><a href="/tusur-gpo/gpo/trees/master/db/migrate">migrate</a></li><li class="file"><a href="/tusur-gpo/gpo/blobs/master/db/migrate/20100210085216_create_issues.rb">20100210085216_create_issues.rb</a></li>      </ul>
              <div id="searchbox">
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/tusur-gpo/gpo/blobs/blame/472e06195f56491c7bb6ae70e9e60a97ccd86723/db/migrate/20100210085216_create_issues.rb" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/tusur-gpo/gpo/blobs/history/master/db/migrate/20100210085216_create_issues.rb" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/tusur-gpo/gpo/blobs/raw/master/db/migrate/20100210085216_create_issues.rb">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-rb">class CreateIssues &lt; ActiveRecord::Migration</pre></td>
</tr>
<tr id="line2">
...
<td class="code"><pre class="prettyprint lang-rb">    create_table :issues do |t|</pre></td>
</tr>
<tr id="line4">
...
<td class="code"><pre class="prettyprint lang-rb">      t.text :description</pre></td>
</tr>
<tr id="line6">
<td class="line-numbers"><a href="#line6" name="line6">6</a></td>
<td class="code"><pre class="prettyprint lang-rb">      t.date :planned_closing_at</pre></td>
</tr>
<tr id="line7">
<td class="line-numbers"><a href="#line7" name="line7">7</a></td>
<td class="code"><pre class="prettyprint lang-rb">      t.integer :planned_grade</pre></td>
</tr>
<tr id="line8">
<td class="line-numbers"><a href="#line8" name="line8">8</a></td>
<td class="code"><pre class="prettyprint lang-rb">      t.date :closed_at</pre></td>
</tr>
<tr id="line9">
<td class="line-numbers"><a href="#line9" name="line9">9</a></td>
<td class="code"><pre class="prettyprint lang-rb">      t.integer :grade</pre></td>
</tr>
<tr id="line10">
...
<td class="code"><pre class="prettyprint lang-rb">      t.timestamps</pre></td>
</tr>
<tr id="line14">
...
<td class="code"><pre class="prettyprint lang-rb">    drop_table :issues</pre></td>
</tr>
<tr id="line19">
